"""Script to create a new versioned build of RDM.

Updates the RDM/version.h file
Prompts the user to review before committing and tagging

This script is meant to be run by an RDM developer on a development workstation. It assumes that
...
def main():
    ...
    parser = argparse.ArgumentParser(description='Create a new versioned build of RDM')
