...
option(RDM_FORCE_SUBMODULE_DEPS "Disable overriding of submodule dependencies with clones at same level as RDM" OFF)
...
function(rdm_add_dependency target loc_variable)
  ...
  if(NOT TARGET ${target})
    ...
    elseif(NOT RDM_FORCE_SUBMODULE_DEPS AND EXISTS "${RDM_ROOT}/../${target}")
