...
#define RDM_VERSION_BUILD 4 /**< The build number. */
/**
 * @}
 */
 ...
 * @{
 */
#define RDM_VERSION_STRING      "0.3.0.4" /**< The 4-digit version string. */
#define RDM_VERSION_DATESTR     "05.Jun.2026" /**< The date this version was released (dd.Mm.yyyy). */
#define RDM_VERSION_COPYRIGHT   "Copyright 2026 ETC Inc." /**< The version's copyright string. */
