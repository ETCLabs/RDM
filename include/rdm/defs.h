/* This file is a modified version of a header publicly available for download from
...
#define E120_NR_PROXY_REJECT                             0x0003 /* Proxy is not the RDM line transmitter and cannot comply with message.*/
