...
inline CmdRespPair GetTcpCommsStatus()
{
  return CmdRespPair{
      {
          {22, 44},              // Source UID
      ...
      {},
      {
          ...
          0,    0,                    // Subdevice
          0x20,                       // Command Class (GET Command)
          0x08, 0x02,                 // PID (E133_TCP_COMMS_STATUS)
          0x00,                       // PD Length
          0x02, 0x30                  // Checksum
      },
      {{33, 66}, {22, 44}, 123, kRdmResponseTypeAck, 0, 0, kRdmCCGetCommandResponse, E133_TCP_COMMS_STATUS},
      {0x64, 0x65, 0x66, 0x61, 0x75, 0x6c, 0x74, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00,
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0xc0, 0xa8, 0x01, 0x02, 0x00, 0x00, 0x00, 0x00, 0x00,
       0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x05, 0x90, 0x00, 0x03},
      {{
          0xcc,                    // START code
          0x01,                    // Sub START code
          0x6f,                    // Message Length
          ...
          0, 0,                    // Subdevice
          0x21,                    // Command Class (GET Response)
          0x08, 0x02,              // PID (E120_IDENTIFY_DEVICE)
          0x57,                    // PD Length
