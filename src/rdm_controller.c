...
lwpa_error_t rdmctl_create_command(const RdmCommand *cmd_data, RdmBuffer *buffer)
{
  ...
  *cur_ptr++ = rdm_length;
  ...
  cur_ptr += 4;
  lwpa_pack_16b(cur_ptr, cmd_data->src_uid.manu);
  cur_ptr += 2;
  lwpa_pack_32b(cur_ptr, cmd_data->src_uid.id);
  cur_ptr += 4;
...
lwpa_error_t rdmctl_unpack_response(const RdmBuffer *buffer, RdmResponse *resp)
{
  ...
  cur_ptr += 4;
  resp->src_uid.manu = lwpa_upack_16b(cur_ptr);
  cur_ptr += 2;
  resp->src_uid.id = lwpa_upack_32b(cur_ptr);
  cur_ptr += 4;
